...
namespace FootballApp.API.Migrations
{
    ...
    [Migration("20210728205801_ChangeIndexTeamMemberStatistics")]
    partial class ChangeIndexTeamMemberStatistics
    {
            ...
            modelBuilder.Entity("FootballApp.API.Models.TeamMemberStatistic", b =>
                {
                    ...
                    b.HasOne("FootballApp.API.Models.TeamMember", "TeamMember")
                        .WithOne("TeamMemberStatistics")
                        .HasForeignKey("FootballApp.API.Models.TeamMemberStatistic", "TeamMemberId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
